        ...
        <div class="col-sm-12">
            <section class="panel">
                ...
                <div id="select_list" class="panel-body" style="padding-top: 25px">
                     <form id="form" class="form-horizontal" action="http://www.spread.com/promoters/game/index.html" method="post">
                        <div class="col-md-11">
...
<div class="row">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.post('index.php?m=member&c=site&a=site_list',{},function (res) {
                $("#list").html(res);
            })
        })
        var site={};
        site.list=function () {
            $("#form").ajaxSubmit({
                url: 'index.php?m=member&c=site&a=site_list',
                data: {dosubmit: 1},
		...
		site.edit_domain=function (id) {
            $("#form").ajaxSubmit({
                url: 'index.php?m=member&c=site&a=site_list',
                data: {dosubmit: 1,id:id},
                success: function (res) {
                    $("#list").empty().html(res);
                }
            });
		...
		editDomain= function(id) {
			"use strict";
			dialogWin({title:'修改密码',url:'index.php?m=member&c=site&a=edit_domain',data:{id:id},width:680,divId:'epd',closeBtn:true,
				btns: {name:'提交',style:'btn-success',callback:"doEditDomain(epd)"}
			},function(winf){});
		};
		doEditDomain=function(winf){
			$(winf).find("form").validate(function () {
				$(winf).find("form").ajaxSubmit({
					url: 'index.php?m=member&c=site&a=edit_domain',
					data: {dosubmit: 1},
					dataType: 'json',
					success: function (r) {
