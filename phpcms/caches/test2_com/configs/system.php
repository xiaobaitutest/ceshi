...
//模板相关配置
'tpl_root' => 'templates2/', //模板保存物理路径
'tpl_name' => 'template2', //当前模板方案目录
'tpl_css' => 'template2', //当前样式目录
'tpl_referesh' => 1,
'tpl_edit'=> 0,//是否允许在线编辑模板

//附件相关配置
'upload_path' => PHPCMS_PATH.'uploadfile/',
'upload_url' => 'http://www.test.com/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://www.test.com/statics/js/', //CDN JS
'css_path' => 'http://www.test.com/statics/css/', //CDN CSS
'img_path' => 'http://www.test.com/statics/images/', //CDN img
'app_path' => 'http://www.test.com/',//动态域名配置地址
'tpl_static_path'=>'http://www.test.com/statics/xiaobaitu_files/',
'charset' => 'utf-8', //网站字符集
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => '1hbi5g9LXT176LSBYu1n', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://www.test.com/phpsso_server',	//接口地址
'phpsso_auth_key' => 'W7pDgl8KVNVs8fMUGzKLkCQ5M5kenpmL', //加密密钥
